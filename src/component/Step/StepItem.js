...
import {CameraReelsFill, ClockFill, Pen, Play, ShieldFill, Trash} from 'react-bootstrap-icons';
...
function BattleRoyalStepItem({step}) {
    const updatedAt = moment(step.updatedAt);
...
function StepItem({workflowId, step}) {
    ...
    >
        ...
        {step.type === 'battle-royal' && <BattleRoyalStepItem step={step}/>}
